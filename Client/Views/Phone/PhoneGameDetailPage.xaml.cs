...
public partial class PhoneGameDetailPage : ContentPage
{
    private readonly ProductTem gameModel;

    public PhoneGameDetailPage(ProductTem game)
    {
        gameModel = game;
        InitializeComponent();
        BindData();
    ...
    private void BindData()
    {
        ...
        gameDescription.Text = gameModel.Description;
        gamePrice.Text = $"Price: ${gameModel.Price:F2}";
        gameReleaseDate.Text = $"Released: {gameModel.ReleasedDate:d}";
        gameGenre.Text = gameModel.GenreName ?? "Unknown";
        gameImage.Source = gameModel.Image;
    }
    ...
    private async void OnEditClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            var page = new PhoneEditGamePage(gameModel);
