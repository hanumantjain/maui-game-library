...
public partial class DesktopHomePageViewModel : BaseViewModel
{
    ...
    public DesktopHomePageViewModel(IProductService productService)
    {
        ...
        try
        {
            CommunityToolkit.Mvvm.Messaging.WeakReferenceMessenger.Default.Register<DesktopHomePageViewModel, Client.Messages.GameDeletedMessage, string>(this, "GameDeleted", (r, m) =>
            {
                var id = m.Value;
